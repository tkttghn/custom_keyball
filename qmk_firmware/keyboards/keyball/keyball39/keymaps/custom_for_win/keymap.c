...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_universal(
        ...
        KC_LCTL  , KC_LALT  ,KC_LGUI  , LALT_T(KC_INT5),LT(1,KC_SPC),LT(7,KC_INT4),RSFT_T(KC_TAB),LT(2,KC_SPC),LSFT_T(KC_LNG2),KC_RALT,KC_RGUI, KC_ESC
    ),
    ...
    [7] = LAYOUT_universal(
        ...
        KC_VOLD  , KC_VOLU  , KC_MUTE  , LGUI(KC_RGHT), XXXXXXX ,                         KC_BTN4  , XXXXXXX  , XXXXXXX  , LGUI(KC_TAB),XXXXXXX,
